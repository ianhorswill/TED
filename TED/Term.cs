...
namespace TED
{
    ...
    public abstract class Term
    {
        ...
        /// </summary>
        public abstract string ToSourceExpression(Compiler.Compiler compiler);
        ...
        /// </summary>
        /// <returns></returns>
        public string ToSourceExpressionParenthesized(Compiler.Compiler compiler)
        {
            var source = ToSourceExpression(compiler);
            return this is IFunctionalExpression ? $"({source})" : source;
        }
    }
...
#pragma warning restore CS0660, CS0661
    {
        ...
        public static implicit operator Term<T>(Placeholder _) => new Var<T>(Language.Gensym($"_{typeof(T).Name}"));
