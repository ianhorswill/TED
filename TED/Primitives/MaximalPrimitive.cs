...
namespace TED.Primitives
{
    ...
    internal sealed class MaximalPrimitive<T1> : Predicate
    {
        ...
        public Goal this[Var<T1> arg, Var<float> utility, Interpreter.Goal g] => new Goal(this, arg, utility, new Constant<Interpreter.Goal>(g));
        ...
        public class Goal : Interpreter.Goal
        {
            ...
            public Goal(MaximalPrimitive<T1> predicate, Var<T1> arg, Var<float> utility, Constant<Interpreter.Goal> g) : base(new Term[] { arg, utility, g })
            {
                this.arg = arg;
            ...
            internal override Interpreter.Goal RenameArguments(Substitution s)
                => new Goal(predicate, (Var<T1>)s.SubstituteVariable(arg), (Var<float>)s.SubstituteVariable(utility), new Constant<Interpreter.Goal>(generator.RenameArguments(s)));
        ...
        private class Call : Interpreter.Call
        {
            ...
            public Call(MaximalPrimitive<T1> predicate, MatchOperation<T1> arg, MatchOperation<float> utility, Interpreter.Call call) : base(Maximal)
            {
                this.arg = arg;
                this.utility = utility;
                goal = call;
            ...
            public override IPattern ArgumentPattern => new Pattern<T1, float, Interpreter.Call>(arg, utility,
    ...
    internal sealed class MaximalPrimitive<T1, T2> : Predicate
    {
        ...
        public Goal this[Var<T1> arg1, Var<T2> arg2, Var<float> utility, Interpreter.Goal g] => new Goal(this, arg1, arg2, utility, new Constant<Interpreter.Goal>(g));
        ...
        public class Goal : Interpreter.Goal
        {
            ...
            public Goal(MaximalPrimitive<T1, T2> predicate, Var<T1> arg1, Var<T2> arg2, Var<float> utility, Constant<Interpreter.Goal> g) : base(new Term[] { arg1, utility, g })
            {
                this.arg1 = arg1;
                this.arg2 = arg2;
                this.utility = utility;
            ...
            internal override Interpreter.Goal RenameArguments(Substitution s)
                => new Goal(predicate, (Var<T1>)s.SubstituteVariable(arg1), (Var<T2>)s.SubstituteVariable(arg2), (Var<float>)s.SubstituteVariable(utility), new Constant<Interpreter.Goal>(generator.RenameArguments(s)));
        ...
        private class Call : Interpreter.Call
        {
            ...
            public Call(MaximalPrimitive<T1, T2> predicate, MatchOperation<T1> arg1, MatchOperation<T2> arg2, MatchOperation<float> utility, Interpreter.Call call) : base(Maximal)
            {
                this.arg1 = arg1;
                this.arg2 = arg2;
                this.utility = utility;
            ...
            public override IPattern ArgumentPattern => new Pattern<T1, T2, float, Interpreter.Call>(arg1, arg2, utility,
                MatchOperation<Interpreter.Call>.Constant(goal));
    ...
    internal sealed class MaximalPrimitive<T1, T2, T3> : Predicate
    {
        ...
        public Goal this[Var<T1> arg1, Var<T2> arg2, Var<T3> arg3, Var<float> utility, Interpreter.Goal g] => new Goal(this, arg1, arg2, arg3, utility, new Constant<Interpreter.Goal>(g));
        ...
        public class Goal : Interpreter.Goal
        {
            ...
            public Goal(MaximalPrimitive<T1, T2, T3> predicate, Var<T1> arg1, Var<T2> arg2, Var<T3> arg3, Var<float> utility, Constant<Interpreter.Goal> g) : base(new Term[] { arg1, utility, g })
            {
                this.arg1 = arg1;
                this.arg2 = arg2;
                this.arg3 = arg3;
            ...
            internal override Interpreter.Goal RenameArguments(Substitution s)
                => new Goal(predicate, (Var<T1>)s.SubstituteVariable(arg1), (Var<T2>)s.SubstituteVariable(arg2), (Var<T3>)s.SubstituteVariable(arg3), (Var<float>)s.SubstituteVariable(utility), new Constant<Interpreter.Goal>(generator.RenameArguments(s)));
        ...
        private class Call : Interpreter.Call
        {
            ...
            public Call(MaximalPrimitive<T1, T2, T3> predicate, MatchOperation<T1> arg1, MatchOperation<T2> arg2, MatchOperation<T3> arg3, MatchOperation<float> utility, Interpreter.Call call) : base(Maximal)
            {
                this.arg1 = arg1;
                this.arg2 = arg2;
                this.arg3 = arg3;
